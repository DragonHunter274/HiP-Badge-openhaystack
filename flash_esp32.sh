...
esptool.py --before no_reset --chip esp32c3 --baud $BAUDRATE --port "$PORT" \
    write_flash --flash_mode dio --flash_size 2MB 0x0000  "$SCRIPT_DIR/build/bootloader/bootloader.bin" \
